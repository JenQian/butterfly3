...
public class Butterfly_old extends AbstractButterfly 
{
	...
	public   TileState[][] M;
			 ...
			 while (true)
		 {
			 ...
			 catch (danaus.CliffCollisionException e) 
			 {
				 ...
				 * the map it terminates the program */
				 if ((gety_position() == getMapHeight()) && (( getDirection() 
						 == danaus.Direction.E) || (getDirection() == 
						 danaus.Direction.W) ) ) {
	 ...
	 {
		//butterfly is in the bottom row flying east, and reaches southeast
		 if ((gety_position() == getMapHeight()) && (getDirection()==
				 danaus.Direction.E) && (getx_position() == getMapWidth())) {
			 return true;
		 }
		//butterfly is in the bottom row flying west, reaches southwest
		 if ((gety_position() == getMapHeight()) && (getDirection()==
				 danaus.Direction.W) && (getx_position() == 0)) {
			 return true;
		 }
		 //butterfly in the bottom row collides a cliff 
